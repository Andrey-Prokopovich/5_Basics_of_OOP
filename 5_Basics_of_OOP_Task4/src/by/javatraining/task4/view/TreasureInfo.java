package by.javatraining.task4.view;
...
public class TreasureInfo {
	...
	public static String formTreasureInfo(Treasure treasure) {
		return treasure.getName() + " стоимостью " + String.format("%.2f", treasure.getValue()) + ".";
	}
}
